...
namespace GameEngine
{
	namespace Display
	{
		...
		public:
			...
			virtual void AddSphereSceneNode(float radius, WeakActorPtr pActor, unsigned int texture, bool debug = false) = 0;
			virtual void AddCubeSceneNode(float dim, WeakActorPtr pActor, unsigned int texture, bool debug = false) = 0;
			virtual void AddMeshSceneNode(const std::string& meshFilePath, WeakActorPtr pActor, unsigned int texture = 0, bool debug = false) = 0;
